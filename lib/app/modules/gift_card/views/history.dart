...
class TransactionList extends StatelessWidget {
  final RxList<SentTransaction> transactions;
  final bool sent;
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              child: Center(
                                child: Text(
                                  transaction.to!.firstName![0].toUpperCase(),
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 16.sp,
...
class AnotherTransactionList extends StatelessWidget {
  final RxList<ReceivedTransaction> transactions;
  final bool sent;

  AnotherTransactionList({required this.transactions, required this.sent});
