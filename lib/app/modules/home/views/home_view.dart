                  ...
                  child: Container(
                    child: Column(
                      children: [
                        ...
                        Obx(() {
                          return controller.isGiftCardReached.value
                              ? buildGiftCards(context)
                              : Container(
                                  height: 100.h,
                                  child: LoadingWidget(placeHolderWidget()));
                        }),
...
/////////////////////Coupons////////////////////////////////////////////
  ...
  buildGiftCards(BuildContext context) {
    controller.getHomeScreenGiftCards();
    print("gift card length ${controller.giftCards.value.length}");
    return Container(
      color: Color(0xffF9F5FF),
      height: 400.h,
      width: MediaQuery.of(context).size.width,
          ...
          children: [
            ...
            Expanded(
              child: ListView.separated(
                  ...
                  itemCount: controller.giftCards.value.length),
            )
          ],
        ),
      ),
